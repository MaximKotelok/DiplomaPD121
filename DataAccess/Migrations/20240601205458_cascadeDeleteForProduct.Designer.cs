...
namespace DataAccess.Migrations
{
    ...
    [Migration("20240601205458_cascadeDeleteForProduct")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsRecomended = true,
                            ParentCategoryID = 9,
                            PathToRecomendedPhoto = "/images/category/recomended/1.png",
                            Title = "Схуднення"
                        },
                        new
                        {
                            ...
                            IsRecomended = true,
                            ParentCategoryID = 2,
                            PathToRecomendedPhoto = "/images/category/recomended/2.png",
                        ...
                        new
                        {
                            ...
                            IsRecomended = true,
                            ParentCategoryID = 2,
                            PathToRecomendedPhoto = "/images/category/recomended/3.png",
                            Title = "Від стресу"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Models.DefectiveSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.PharmaCompany", b =>
                {
                    b.HasOne("Domain.Models.User", "User")
                        .WithOne("PharmaCompany")
                        .HasForeignKey("Domain.Models.PharmaCompany", "UserID");
            ...
            modelBuilder.Entity("Domain.Models.ProductConfirm", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Product", "Product")
                        .WithOne("ProductConfirm")
                        .HasForeignKey("Domain.Models.ProductConfirm", "ProductID")
                        .OnDelete(DeleteBehavior.Cascade);
