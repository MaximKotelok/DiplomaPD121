...
import "./InputForBrandComponent.css"



const InputForBrandComponent = ({label, type, name, value = '', onChange, placeholder="...", className, error}) => {
...
export default InputForBrandComponent;
