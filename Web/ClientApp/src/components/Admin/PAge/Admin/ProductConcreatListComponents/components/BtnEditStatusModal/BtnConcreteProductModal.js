...
import { deleteConcreteProduct } from "../../../../../../../services/concreteProduct";

function BtnConcreteProductModal({id}) {
        ...
        <Modal.Body>                    
          <div className={`d-flex`}>
            <Link 
              ...
              to={`/admin/updateProductPharmacy/${id}`}>
                Оновити
            </Link>
            <button className="btn btn-danger" onClick={async ()=>{
              let res = await deleteConcreteProduct(id);
              if(res.status === Success){
...
export default BtnConcreteProductModal;
