...
import "./InputForPharmacyComponent.css"



const InputForPharmacyComponent = ({label, type, name, value = '', onChange, placeholder="...", className, error}) => {
...
export default InputForPharmacyComponent;
