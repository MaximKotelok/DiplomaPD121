...
import "./InputForPharmaCompanyComponent.css"



const InputForPharmaCompanyComponent = ({label, type, name, value = '', onChange, placeholder="...", className, error}) => {
...
export default InputForPharmaCompanyComponent;
