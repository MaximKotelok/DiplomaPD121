...
import { getPharmacyById, upsertPharmacy } from "../../../../../services/pharmacy"
                ...
                <div className='flip'>
                    ...
                    <div className="margin-bottom select-div">
                        <CustomSelectComponent
                            ...
                            options={dataFromServer.pharmaCompanies &&
                                dataFromServer.pharmaCompanies.map &&
                                dataFromServer.pharmaCompanies.map(item => ({ value: item.id, label: item.title }))}
                        ...
                        <CustomSelectComponent
                            ...
                            name="cityID"
                            placeholder="Місто"
                            options={dataFromServer.cities &&
                                dataFromServer.cities.map &&
                                dataFromServer.cities.map(item => ({ value: item.id, label: item.nameCity }))}
                            onChange={selectedOption => {
                                setFormData({
                                    ...formData,
