...
import "./MiniProductCardComponent2.css";
...
const MiniProductCardComponent2 = ({
  id = 0,
        ...
        <div className="product-info">
          <Link to={`/product-details/${id}`} className="text-decoration-none">
            ...
            <p className="product-description">
              {description && minimizeText(description, 30)}
            </p>
          </Link>
        </div>
        <p className=" mt-3 product-price">
          від <span className="product-price-bold">{minPrice && minPrice}</span>{" "}
          грн
        </p>
      </div>
    </div>
...
export default MiniProductCardComponent2;
